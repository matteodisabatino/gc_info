...
disa::HeapStats disa::operator-(disa::HeapStats &lhs, disa::HeapStats &rhs)
{
  ...
  result.set_total_physical_size(
      lhs.total_physical_size() - rhs.total_physical_size());
  result.set_total_available_size(
      lhs.total_available_size() - rhs.total_available_size());
  result.set_malloced_memory(lhs.malloced_memory() - rhs.malloced_memory());
  result.set_peak_malloced_memory(
      lhs.peak_malloced_memory() - rhs.peak_malloced_memory());
  result.set_number_of_native_contexts(
      lhs.number_of_native_contexts() - rhs.number_of_native_contexts());
  result.set_number_of_detached_contexts(
      lhs.number_of_detached_contexts() - rhs.number_of_detached_contexts());
  ...
  result.set_total_global_handles_size(
      lhs.total_global_handles_size() - rhs.total_global_handles_size());
  result.set_used_global_handles_size(
      lhs.used_global_handles_size() - rhs.used_global_handles_size());
#endif
...
disa::HeapStats::HeapStats(v8::HeapStatistics &stats)
{
  ...
  this->total_physical_size_ = static_cast<double>(
      stats.total_physical_size());
  this->total_available_size_ = static_cast<double>(
      stats.total_available_size());
  this->malloced_memory_ = static_cast<double>(stats.malloced_memory());
  this->peak_malloced_memory_ = static_cast<double>(
...
v8::Local<v8::Object> disa::HeapStats::ToV8Object()
{
  ...
  Nan::Set(obj, Nan::New("totalHeapSize").ToLocalChecked(),
           Nan::New<v8::Number>(this->total_heap_size_));
  Nan::Set(obj, Nan::New("totalHeapSizeExecutable").ToLocalChecked(),
           Nan::New<v8::Number>(this->total_heap_size_executable_));
  Nan::Set(obj, Nan::New("usedHeapSize").ToLocalChecked(),
           Nan::New<v8::Number>(this->used_heap_size_));
  Nan::Set(obj, Nan::New("heapSizeLimit").ToLocalChecked(),
           Nan::New<v8::Number>(this->heap_size_limit_));
  Nan::Set(obj, Nan::New("totalPhysicalSize").ToLocalChecked(),
           Nan::New<v8::Number>(this->total_physical_size_));
  Nan::Set(obj, Nan::New("totalAvailableSize").ToLocalChecked(),
           Nan::New<v8::Number>(this->total_available_size_));
  Nan::Set(obj, Nan::New("mallocedMemory").ToLocalChecked(),
           Nan::New<v8::Number>(this->malloced_memory_));
  Nan::Set(obj, Nan::New("peakMallocedMemory").ToLocalChecked(),
           Nan::New<v8::Number>(this->peak_malloced_memory_));
  Nan::Set(obj, Nan::New("numberOfNativeContexts").ToLocalChecked(),
           Nan::New<v8::Number>(this->number_of_native_contexts_));
  Nan::Set(obj, Nan::New("numberOfDetachedContexts").ToLocalChecked(),
           Nan::New<v8::Number>(this->number_of_detached_contexts_));

#if NODE_MODULE_VERSION >= NODE_12_0_MODULE_VERSION
  Nan::Set(obj, Nan::New("externalMemory").ToLocalChecked(),
           Nan::New<v8::Number>(this->external_memory_));
#endif

#if NODE_MODULE_VERSION >= NODE_14_0_MODULE_VERSION
  Nan::Set(obj, Nan::New("totalGlobalHandlesSize").ToLocalChecked(),
           Nan::New<v8::Number>(this->total_global_handles_size_));
  Nan::Set(obj, Nan::New("usedGlobalHandlesSize").ToLocalChecked(),
           Nan::New<v8::Number>(this->used_global_handles_size_));
#endif
